...
**Current status: zero setups have cleared the promotion bar (six variants tested now: close_any, close_min_distance, full_bar_range, the FVG entry trigger, and the two trend-structure-liquidity-filter variants). Deciding what to test next.**
