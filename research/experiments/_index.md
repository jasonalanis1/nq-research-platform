...
|----|-----------|------|----------|------------|---------|
| exp-001 | Opening Range Breakout (15-min range, 60-min watch, 1x-range target) has an edge at the NQ 8:30 NY open | 2026-08-15 | 37.0% | -0.29R | retest — pipeline validation only, see notes |
