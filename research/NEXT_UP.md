...
## Queue
   ...
   0-ACCEL. BATCH SCREENING (Jason, Sept 14th ~8 pm CT: "push this as fast as possible"). Build
      src/batch_screen.py per research/infrastructure/acceleration-plan-2026-09-14.md Lever C.
      Overnight cycles own this. Survivors go to the shelf; the full pipeline is unchanged for them.
